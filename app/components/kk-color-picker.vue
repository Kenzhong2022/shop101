<template>
  ...
  <div
    v-if="true"
    class="max-xl:hidden flex flex-col items-start gap-24px p-24px border border-solid border-#fff rounded-8px max-w-360px bg-#fff fixed top-50px right-12px z-999 shadow-lg"
  >
    <!-- 只剩最大色环 -->
    <div
